     ...
     */
      ...
      */
      ...
      public boolean isParticipante(int eventoId, int usuarioId) {
        ...
        /**
         * Marca a presença de um usuário em um evento.
         *
         * @param eventoId ID do evento
         * @param usuarioId ID do usuário
         * @param presente true se estiver presente, false se ausente
         */
        ...
        /**
         * Retorna a presença de um usuário em um evento.
         *
         * @param eventoId ID do evento
         * @param usuarioId ID do usuário
         * @return true se estiver marcado como presente, false caso contrário
         */
